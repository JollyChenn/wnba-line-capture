...
- **Chennedy Carter** (Las Vegas Aces, Las Vegas Aces @ New York Liberty): points median~16→proj~10.8 fair[11.0=1.96 12.0=1.8 13.0=1.67] · PR 17→14.1 · PA 16→13.7 · PRA 18→12.6 · [declining+cold+stingy] · last5 mins [19 9 8 8 16] oppDef 85 · UNDER value zone = book line between proj and median (MAX edge near median)
- **NaLyssa Smith** (Las Vegas Aces, Las Vegas Aces @ New York Liberty): points median~10→proj~8.7 fair[8.5=2.07 9.5=1.8 10.5=1.6] · PR 16→14.0 · PA 12→9.9 · PRA 16→14.4 · [cold+stingy] · last5 mins [31 27 23 30 14] oppDef 85 ⚠VERIFY (last game anomaly — skip if blowout/garbage time) · UNDER value zone = book line between proj and median (MAX edge near median)

## CASCADE contingencies — fire ONLY on scratch news (PRA OVER rank-3-6, flat 1u)

- Las Vegas Aces: if **A'ja Wilson** OUT -> (fair 1.75, bet if 1xbet over > 1.75) Chelsea Gray OVER 24.5 PRA, NaLyssa Smith OVER 16.5 PRA, Jewell Loyd OVER 9.5 PRA, Chennedy Carter OVER 17.5 PRA
- New York Liberty: if **Breanna Stewart** OUT -> (fair 1.75, bet if 1xbet over > 1.75) Sabrina Ionescu OVER 13.5 PRA, Leonie Fiebich OVER 13.5 PRA, Marine Johannes OVER 11.5 PRA
