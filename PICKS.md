...
- **Kiki Iriafen** (Washington Mystics, Toronto Tempo @ Washington Mystics): PRA median~26→proj~23.0 fair[23.0=2.0 24.0=1.85 25.0=1.72] · PR 24→21.4 · RA 11→9.1 · reb⚠frag 10→8.6 · [disrupted+cold] · last5 mins [24 27 27 27 8] oppDef 93 ⚠VERIFY (last game anomaly — skip if blowout/garbage time) · UNDER value zone = book line between proj and median (MAX edge near median=book naive, NONE near proj=book moved)
...
- **Dominique Malonga** (Seattle Storm, Golden State Valkyries @ Seattle Storm): PRA median~24→proj~20.9 fair[21.0=1.98 22.0=1.81 23.0=1.67] · PR 23→20.6 · [cold+stingy] · last5 mins [20 32 14 17 24] oppDef 81 · UNDER value zone = book line between proj and median (MAX edge near median=book naive, NONE near proj=book moved)
