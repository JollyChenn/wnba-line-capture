# WNBA core picks — 2026-06-12

_Stingy-D threshold (trailing-10 allowed, bottom quartile): 81_

## REAL-MONEY CORE — UNDER pts (need >=2 signals, flat 1u)

- **Kiki Iriafen** (Washington Mystics, Toronto Tempo @ Washington Mystics): PR median~24→proj~21.4 fair[21.5=1.98 22.5=1.83 23.5=1.69] · RA 11→9.1 · PRA 26→23.0 · reb⚠frag 10→8.6 · [disrupted+cold] · last5 mins [24 27 27 27 8] oppDef 93 ⚠VERIFY (last game anomaly — skip if blowout/garbage time) · UNDER value zone = book line between proj and median (MAX edge near median=book naive, NONE near proj=book moved)
- **Laura Juskaite** (Toronto Tempo, Toronto Tempo @ Washington Mystics): **PRA OVER** median~15→proj~16.9 fair[17.0=2.03 16.0=1.8 15.0=1.61] · [hot+leaky] · last5 mins [22 25 20 22 37] oppDef 87 · OVER value zone = book line between median and proj (MAX edge near median)
- **Dominique Malonga** (Seattle Storm, Golden State Valkyries @ Seattle Storm): PR median~23→proj~20.6 fair[20.5=2.03 21.5=1.85 22.5=1.69] · PRA 24→20.9 · [cold+stingy] · last5 mins [20 32 14 17 24] oppDef 81 · UNDER value zone = book line between proj and median (MAX edge near median=book naive, NONE near proj=book moved)
